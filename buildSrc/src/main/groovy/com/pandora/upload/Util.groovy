...
class Util {
    ...
    static void upload(File rootDir) throws Exception {
        ...
        if (sIsTest) {
            ...
            jenkinsWorkspace = rootDir.getPath()
        }
        ...
        def appName = configJson.appName //应用名称
        def appVersion = configJson.versionName //应用版本号
        def appPackageName = configJson.applicationId//应用包名
        def apiToken = configJson.upload.apiToken//fir api Token
